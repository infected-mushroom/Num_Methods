import numpy as np
from solve_sys import solve_linear_system
...
'''grid = [1, 2, 3, 4, 5, 6]
values = [1.0002, 1.0341, 0.6, 0.40105, 0.1, 	0.23975]
tabulated = TabulatedFunction(grid, values)
print interpolate(tabulated).coefficients'''
